...
struct {
  ...
  TokenType tokenType;
    ...
    {"PROGRAM", KW_PROGRAM},   {"CONST", KW_CONST},
    {"TYPE", KW_TYPE},         {"VAR", KW_VAR},
    {"INTEGER", KW_INTEGER},   {"CHAR", KW_CHAR},
    {"ARRAY", KW_ARRAY},       {"OF", KW_OF},
    {"FUNCTION", KW_FUNCTION}, {"PROCEDURE", KW_PROCEDURE},
    {"BEGIN", KW_BEGIN},       {"END", KW_END},
    {"CALL", KW_CALL},         {"IF", KW_IF},
    {"THEN", KW_THEN},         {"ELSE", KW_ELSE},
    {"WHILE", KW_WHILE},       {"DO", KW_DO},
    {"FOR", KW_FOR},           {"TO", KW_TO},
    {"STRING", KW_STRING},     {"DOUBLE", KW_DOUBLE},
    {"RETURN", KW_RETURN},     {"REPEAT", KW_REPEAT},
    {"UNTIL", KW_UNTIL},       {"SWITCH", KW_SWITCH},
    {"CASE", KW_CASE},         {"DEFAULT", KW_DEFAULT},
    {"BREAK", KW_BREAK},       {"SUM", KW_SUM},
    {"FLOAT", KW_FLOAT},       {"SHORT", KW_SHORT},
    {"LONG", KW_LONG},
};
